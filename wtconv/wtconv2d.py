...
class WTConv2d(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(self.wt_levels):
            ...
            ############################# debug code #############################
            # print(f"type of curr_x is {type(curr_x)}, with its shape {curr_x.shape}")
            # print(f"x_ll has shape {curr_x[:,:,0,:,:].shape}")
            # print(f"x_hl has shape {curr_x[:,:,1,:,:].shape}")
            # print(f"x_lh has shape {curr_x[:,:,2,:,:].shape}")
            # print(f"x_hh has shape {curr_x[:,:,3,:,:].shape}")
            ############################# debug code #############################
            curr_x_ll = curr_x[:,:,0,:,:]
